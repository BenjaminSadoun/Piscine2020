...
<body>
    ...
    $sql = 'SELECT numID, prixInitial, prixFinal, nom, vignette, description FROM item WHERE categorie = 2';
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card z-depth-0">
                        <div class="card-content center">
                            ...
                            <div><button><a href="vip.php?numID=<?php echo $info['numID']; ?>"
                             type="button" class="#" action="infosobjet2.php" method="GET">Plus d'informations</a></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    if (isset($_GET["numID"])) {
        ...
        $req = $bdd->prepare("SELECT numID, prixInitial, prixFinal, nom, vignette, IDVend, description 
                                FROM item WHERE numID = :numID and categorie = 2");
