...
<body>
    ...
    $sql = 'SELECT numID, prixInitial, nom, vignette, description FROM item WHERE categorie = 1';
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card z-depth-0">
                        <div class="card-content center">
                            ...
                            <div><button><a href="musee.php?numID=<?php echo $info['numID']; ?>"
                             type="button" class="#" action="infosobjet1.php" method="GET">Plus d'informations</a></button>
                            </div>
                        </div>
                    </div>
                </div>
