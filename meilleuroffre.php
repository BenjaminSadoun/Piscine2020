...
<body>
    ...
    $sql = 'SELECT numID, prixInitial, nom, vignette, description FROM item WHERE typeVente = 1';
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card z-depth-0">
                        <div class="card-content center">
                            ...
                            <div><button><a href="meilleuroffre.php?numID=<?php echo $info['numID']; ?>"
                             type="button" class="#" action="in.php" method="GET">Plus d'informations</a></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    if (isset($_GET["numID"])) {
        ...
        $req = $bdd->prepare("SELECT numID, prixInitial, nom, vignette, typeVente, IDVend, description 
                                FROM item WHERE numID = :numID and typeVente = 1");
